use super::{
    gamelog::GameLog, CombatStats, Confusion, Consumable, InBackpack, Item, Map, Name, Position,
    ProvidesHealing, SufferDamage, WantsToDropItem, WantsToPickupItem, WantsToUseItem, Equippable,
    Equipped
};
use crate::components::{AreaOfEffect, InflictsDamage};
use specs::prelude::*;
